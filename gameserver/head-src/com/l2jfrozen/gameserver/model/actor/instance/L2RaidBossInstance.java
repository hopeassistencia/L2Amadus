...
public final class L2RaidBossInstance extends L2MonsterInstance
{
	...
	public boolean doDie(L2Character killer)
	{
	   ...
	   {
	       if (Config.ENABLE_CUSTOM_DROP_RB && getNpcId() == Config.ID_RB_CUSTOM_DROP && player.isInsideRadius(getX(), getY(), getZ(), 1200, false, false) && checkCountItemInventory(Config.ID_ITEM_REQUIRED, Config.COUNT_ITEM_REQUIRED, player))
	       {

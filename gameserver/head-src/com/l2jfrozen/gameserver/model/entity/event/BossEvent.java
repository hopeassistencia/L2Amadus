 ...
 * O Evento funciona da seguinte forma ele da respawn em um mob em uma das 10 loc aleatorias e faz o announce se ninguem matar o mob em tempo determinado deleta o mob ou se alguem matar tambem deleta.
...
public class BossEvent
{
 ...
 Announcements.getInstance().gameAnnounceToAll("Fim do Evento Treasure");
 unspawnEventBoss();
 }
 ...
 _bossSpawn.getLastSpawn().deleteMe();
 _bossSpawn.stopRespawn();
 Announcements.getInstance().gameAnnounceToAll("Fim de Evento o boss foi morto");
 SpawnTable.getInstance().deleteSpawn(_bossSpawn, true);
 }
